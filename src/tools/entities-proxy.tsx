...
class EntitiesProxy {
  ...
  // constructor(baseUrl: string = "" +"/BACKEND_PROJ_1cd476cd_snap_20260831_021440_707_snap_20260831_021440_707"+"/api/entities") {
  //   this.baseUrl = baseUrl;
  // }
  constructor(
    baseUrl: string = '' +
      '/backendcommon/api/zaki/PROJ_1cd476cd_snap_20260831_021440_707_snap_20260831_021440_707' +
      '/entities-handler'
  ) {
    ...
    this.baseUrl =
      ...
      (dynamicBase
        ? '' +
          ...
          '/entities-handler'
        : '' +
          '/backendcommon/api/zaki/PROJ_1cd476cd_snap_20260831_021440_707_snap_20260831_021440_707/entities-handler');
  }
