...
const nextConfig = {
  ...
  ...(process.env.NODE_ENV !== 'production' && {
    async rewrites() {
      return [
        {
          source: "/flow-engine/Autocode Project/v2/run_flow",
          destination: "https://pztest.koudingvip.com/flow-engine/Autocode Project/v2/run_flow",
        },
        {
  ...
  env: {
    NEXT_PUBLIC_PROJECT_ID: process.env.NEXT_PUBLIC_PROJECT_ID || 'PROJ_1cd476cd_snap_20260831_021440_707',
    NEXT_PUBLIC_BASE_PATH: process.env.NEXT_PUBLIC_BASE_PATH || '',
    NEXT_PUBLIC_API_BASE_URL: process.env.NEXT_PUBLIC_API_BASE_URL || '',
    NEXT_PUBLIC_RUNTIME_API: 'https://pre.autocode.cc/rpc',
    NEXT_PUBLIC_SITE_TITLE:
      process.env.NEXT_PUBLIC_SITE_TITLE || "Children's Toy Brand E-Commerce Platform"
  },
