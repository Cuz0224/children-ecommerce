...
import {
    ...
    THIRD_PARTY_NOWPAYMENTS_API_KEY,
    THIRD_PARTY_NOWPAYMENTS_IPN_SECRET,
    THIRD_PARTY_NOWPAYMENTS_API_BASE_URL,
    THIRD_PARTY_NOWPAYMENTS_API_KEY_DEPLOY,
    THIRD_PARTY_NOWPAYMENTS_IPN_SECRET_DEPLOY,
    THIRD_PARTY_NOWPAYMENTS_API_BASE_URL_DEPLOY,
...
export function resolveNowPaymentsSecrets() {
    return {
        apiKey: resolvePaymentSecret(
            THIRD_PARTY_NOWPAYMENTS_API_KEY,
            THIRD_PARTY_NOWPAYMENTS_API_KEY_DEPLOY,
        ...
        ipnSecret: resolvePaymentSecret(
            THIRD_PARTY_NOWPAYMENTS_IPN_SECRET,
            THIRD_PARTY_NOWPAYMENTS_IPN_SECRET_DEPLOY,
            'THIRD_PARTY_NOWPAYMENTS_IPN_SECRET',
        ),
